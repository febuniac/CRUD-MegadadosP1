...
@WebServlet("/ServiceAtualizaConta")
public class ServiceAtualizaConta extends HttpServlet {
     ...
     throws IOException, ServletException {
        ...
        String json = new Gson().toJson(conta);
 		...
 		String url = "http://localhost:8080/billOrganizer/RecebeJsonAtualizaConta";
